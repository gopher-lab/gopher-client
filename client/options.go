...
// IdleConnTimeout sets the timeout before an idle connection closes itself. The default is 2 minutes.
...
// HttpClient specifies the http.Client to use. If provided, connection options are ignored.
